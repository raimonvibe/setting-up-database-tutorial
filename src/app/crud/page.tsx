    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="prose max-w-none">
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6 mb-8">
          <h3 className="text-blue-900 dark:text-blue-200 mb-2">What You&apos;ll Learn</h3>
        ...
        <div className="grid md:grid-cols-4 gap-4 mb-8">
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
            ...
            <p className="text-sm text-blue-900 dark:text-gray-300">POST requests to add new data</p>
          </div>
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
            <Eye className="h-6 w-6 text-blue-600 mb-2" />
            <h4 className="font-semibold mb-1">Read</h4>
            <p className="text-sm text-blue-900 dark:text-gray-300">GET requests to fetch data</p>
          </div>
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
            <Edit className="h-6 w-6 text-yellow-600 mb-2" />
            <h4 className="font-semibold mb-1">Update</h4>
            <p className="text-sm text-blue-900 dark:text-gray-300">PUT requests to modify data</p>
          </div>
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
            <Trash2 className="h-6 w-6 text-red-600 mb-2" />
            <h4 className="font-semibold mb-1">Delete</h4>
            <p className="text-sm text-blue-900 dark:text-gray-300">DELETE requests to remove data</p>
          </div>
        </div>
...
curl -X DELETE http://localhost:3000/api/tasks/[task-id]`}
        ...
        <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-6 mb-8">
          <div className="flex items-center mb-2">
            ...
            <h3 className="text-blue-900 dark:text-green-200">CRUD Complete!</h3>
          </div>
