    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="prose max-w-none">
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6 mb-8">
          <h3 className="text-blue-800 dark:text-blue-200 mb-2">Why These Technologies?</h3>
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-8">
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">JavaScript runtime environment</p>
          </div>
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
            <FileText className="h-6 w-6 text-blue-600 mb-2" />
            <h4 className="font-semibold mb-1">Code Editor</h4>
            <p className="text-sm text-gray-600 dark:text-gray-300">VS Code recommended</p>
          </div>
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
            <Database className="h-6 w-6 text-purple-600 mb-2" />
            <h4 className="font-semibold mb-1">Basic SQL</h4>
            <p className="text-sm text-gray-600 dark:text-gray-300">Understanding of database concepts</p>
          </div>
        </div>
...
└── ...other files`}
        ...
        <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-6 mb-8">
          <div className="flex items-center mb-2">
            ...
            <h3 className="text-green-800 dark:text-green-200">Setup Complete!</h3>
          </div>
