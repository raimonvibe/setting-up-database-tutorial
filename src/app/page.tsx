  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-blue-900 dark:text-gray-300 max-w-3xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
        <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg border border-gray-200 dark:border-gray-700">
          ...
          <h3 className="text-xl font-semibold mb-2 text-blue-900 dark:text-white">Environment Setup</h3>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg border border-gray-200 dark:border-gray-700">
          ...
          <h3 className="text-xl font-semibold mb-2 text-blue-900 dark:text-white">Database Schema</h3>
          <p className="text-blue-900 dark:text-gray-300 mb-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg border border-gray-200 dark:border-gray-700">
          ...
          <h3 className="text-xl font-semibold mb-2 text-blue-900 dark:text-white">CRUD Operations</h3>
          <p className="text-blue-900 dark:text-gray-300 mb-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg border border-gray-200 dark:border-gray-700">
          ...
          <h3 className="text-xl font-semibold mb-2 text-blue-900 dark:text-white">Relationships</h3>
          <p className="text-blue-900 dark:text-gray-300 mb-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg border border-gray-200 dark:border-gray-700">
          ...
          <h3 className="text-xl font-semibold mb-2 text-blue-900 dark:text-white">Interactive Demo</h3>
          <p className="text-blue-900 dark:text-gray-300 mb-4">
        ...
        <div className="bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg p-6 shadow-lg border border-blue-200 dark:border-blue-800">
          <div className="text-center">
            <h3 className="text-xl font-semibold mb-2 text-blue-900 dark:text-white">Ready to Start?</h3>
            <p className="text-blue-900 dark:text-gray-300 mb-4">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <ul className="space-y-3">
            <li className="flex items-start">
              ...
              <span className="text-blue-900 dark:text-gray-300">Setting up Prisma with Next.js and SQLite</span>
            </li>
            <li className="flex items-start">
              <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 mr-3 flex-shrink-0"></div>
              <span className="text-blue-900 dark:text-gray-300">Designing database schemas and models</span>
            </li>
            <li className="flex items-start">
              <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 mr-3 flex-shrink-0"></div>
              <span className="text-blue-900 dark:text-gray-300">Implementing CRUD operations with type safety</span>
            </li>
            <li className="flex items-start">
              <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 mr-3 flex-shrink-0"></div>
              <span className="text-blue-900 dark:text-gray-300">Working with database relationships</span>
            </li>
          </ul>
          <ul className="space-y-3">
            <li className="flex items-start">
              <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 mr-3 flex-shrink-0"></div>
              <span className="text-blue-900 dark:text-gray-300">Creating API routes for database operations</span>
            </li>
            <li className="flex items-start">
              <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 mr-3 flex-shrink-0"></div>
              <span className="text-blue-900 dark:text-gray-300">Building interactive user interfaces</span>
            </li>
            <li className="flex items-start">
              <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 mr-3 flex-shrink-0"></div>
              <span className="text-blue-900 dark:text-gray-300">Error handling and validation</span>
            </li>
            <li className="flex items-start">
              <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 mr-3 flex-shrink-0"></div>
              <span className="text-blue-900 dark:text-gray-300">Best practices for production applications</span>
            </li>
          </ul>
        </div>
      </div>
