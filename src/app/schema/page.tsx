      ...
      <div className="prose max-w-none">
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-8">
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">People who create and manage tasks</p>
          </div>
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
            <Tag className="h-6 w-6 text-green-600 mb-2" />
            <h4 className="font-semibold mb-1">Category</h4>
            <p className="text-sm text-gray-600 dark:text-gray-300">Groups to organize tasks</p>
          </div>
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
            <CheckSquare className="h-6 w-6 text-purple-600 mb-2" />
            <h4 className="font-semibold mb-1">Task</h4>
            <p className="text-sm text-gray-600 dark:text-gray-300">Individual items to be completed</p>
          </div>
        </div>
...
npx prisma studio`}
        ...
        <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-6 mb-8">
          <h3 className="text-green-800 dark:text-green-200 mb-2">Pro Tips</h3>
