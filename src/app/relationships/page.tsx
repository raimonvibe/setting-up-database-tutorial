    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="prose max-w-none">
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6 mb-8">
          <h3 className="text-blue-900 dark:text-blue-200 mb-2">Why Relationships Matter</h3>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700 mb-8">
          <div className="flex items-center justify-center space-x-8 mb-6">
            <div className="text-center">
              ...
              <p className="text-sm text-blue-900 dark:text-gray-300">One user</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-blue-900 dark:text-gray-300">Many tasks</p>
            </div>
          </div>
          <div className="flex items-center justify-center space-x-8">
            <div className="text-center">
              ...
              <p className="text-sm text-blue-900 dark:text-gray-300">One category</p>
            </div>
            <ArrowRight className="h-6 w-6 text-blue-700" />
            <div className="text-center">
              <div className="bg-green-100 dark:bg-green-900 p-4 rounded-lg mb-2">
...
model Task {
  ...
  @@map("tasks")
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700 mb-6">
          ...
          <ul className="space-y-2 text-blue-900 dark:text-gray-300">
      ...
      name: 'asc',
        ...
        <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-6 mb-8">
          <div className="flex items-center mb-2">
            ...
            <h3 className="text-blue-900 dark:text-green-200">Relationships Mastered!</h3>
          </div>
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6 mb-8">
          <h3 className="text-blue-900 dark:text-blue-200 mb-2">Best Practices</h3>
          <ul className="text-blue-900 dark:text-blue-300 space-y-1">
